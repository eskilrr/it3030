...
class DataGenerator():
    ...
    def selfMadeData(self, globals, circle, cross, rectangle, bars):
        ...
        x_train, y_train = self.get_train_test_data(train, dim)
        x_valid, y_valid = self.get_train_test_data(validation, dim)
        x_test, y_test = self.get_train_test_data(test, dim)

        return (x_train, y_train), (x_valid, y_valid), (x_test, y_test)

    # Helper method for getting the data in the right dims.
    def get_train_test_data(self, data, dim):
